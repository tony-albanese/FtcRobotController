...
@TeleOp(name = "Fabian", group = "Linear Opmode")
public class FabianMrRobot extends LinearOpMode {
    ...
    private void readGamepadCommands() {
        ...
        // shoulderPosition.setPosition 0.0(gamepad1.left_triger);
        // sleep(1000);
        // shoulderPosition.setPosition 0.0(gamepad1.right_triger);

        // TODO 5: Program the buttons that control the elbow servos.

        // elbowPosition.setPosition(gamepad1.left_bumper);
        // sleep(1000);
        // elbowPosition.setPosition(gamepad1.right_bumper);
        // sleep(1000);
    }
