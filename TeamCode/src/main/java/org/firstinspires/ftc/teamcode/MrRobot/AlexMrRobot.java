...
@TeleOp(name = "Seidler", group = "Linear Opmode")
public class AlexMrRobot extends LinearOpMode {
    ...
    private void readGamepadCommands(){
        ...
        leftDriveTwo.setPower(gamepad1.right_stick_x);

        rightDriveTwo.setPower(gamepad1.right_stick_x);
        ...
        leftElbow.setPosition(gamepad1.left_trigger);

        rightElbow.setPosition(gamepad1.right_trigger);
    }
